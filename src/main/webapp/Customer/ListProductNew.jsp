                ...
                <ul class="pagination">
                    <li class="page-item">
                        <c:if test = "${currentPage > 1}">
                            <a class="page-link" href="Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}&page=${currentPage-1}" aria-label="Previous">
                    ...
                    <c:forEach var = "i" begin = "1" end = "${totalPage}">
                        <li class='page-item'><a class='page-link <c:if test = "${currentPage == i}">text-danger</c:if>' href='Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}&page=${i}'>${i}</a></li>
                    </c:forEach>
                    <li class="page-item">
                        <c:if test = "${currentPage < totalPage}">
                            <a class="page-link" href="Product?chucNang=hienThiSanPhamMoi&danhMucSanPham=${categoryName}&page=${currentPage+1}" aria-label="Next">
