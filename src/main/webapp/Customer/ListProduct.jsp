        	    ...
        	    <div class="col-md-2 col-12 d-none d-md-block">
                    ...
                    <c:choose>
                        <c:when test = "${(fn:contains(categoryName, 'Nữ')) || (fn:contains(categoryName, 'Áo nữ')) || (fn:contains(categoryName, 'Quần nữ')) || (fn:contains(categoryName, 'Váy nữ')) || (fn:contains(categoryName, 'Phụ kiện nữ'))}">
                            ...
                            <a class='mt-3 font-weight-bold' href='Product?chucNang=sanPhamGiamGia&danhMucSanPham=Nữ'>Sản phẩm giảm giá</a>
                        ...
                        <c:when test = "${(fn:contains(categoryName, 'Nam')) || (fn:contains(categoryName, 'nam')) }">
                            ...
                            <a class='mt-3 font-weight-bold' href='Product?chucNang=sanPhamGiamGia&danhMucSanPham=Nam'>Sản phẩm giảm giá</a>
                            <p class='font-weight-bold mb-1 mt-2'>Danh mục sản phẩm</p>
                            <ul class='list-unstyled'>
                        ...
                        <c:when test = "${(fn:contains(categoryName, 'Bé gái')) || (fn:contains(categoryName, 'bé gái')) }">
                            ...
                            <a class='mt-3 font-weight-bold' href='Product?chucNang=sanPhamGiamGia&danhMucSanPham=Bé gái'>Sản phẩm giảm giá</a>
                            <p class='font-weight-bold mb-1 mt-2'>Danh mục sản phẩm</p>
                            <ul class='list-unstyled'>
                        ...
                        <c:when test = "${(fn:contains(categoryName, 'Bé trai')) || (fn:contains(categoryName, 'bé trai')) }">
                             ...
                             <a class='mt-3 font-weight-bold' href='Product?chucNang=sanPhamGiamGia&danhMucSanPham=Bé trai'>Sản phẩm giảm giá</a>
                             <p class='font-weight-bold mb-1 mt-2'>Danh mục sản phẩm</p>
                             <ul class='list-unstyled'>
                ...
                <ul class="pagination">
                    <li class="page-item">
                        <c:if test = "${currentPage > 1}">
                            <a class="page-link" href="Product?chucNang=hienThiTheoDanhMuc&danhMucSanPham=${categoryName}&page=${currentPage-1}" aria-label="Previous">
                    ...
                    <c:forEach var = "i" begin = "1" end = "${totalPage}">
                        <li class='page-item'><a class='page-link <c:if test = "${currentPage == i}">text-danger</c:if>' href='Product?chucNang=hienThiTheoDanhMuc&danhMucSanPham=${categoryName}&page=${i}'>${i}</a></li>
                    </c:forEach>
                    <li class="page-item">
                        <c:if test = "${currentPage < totalPage}">
                            <a class="page-link" href="Product?chucNang=hienThiTheoDanhMuc&danhMucSanPham=${categoryName}&page=${currentPage+1}" aria-label="Next">
